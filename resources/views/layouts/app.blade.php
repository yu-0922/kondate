...
<html>
    ...
    <body>
    <!----- ヘッダー ----->
    <header><a href={{ route('menu.index') }}><img src="{{ asset('images/freefont_logo_jk-maru-gothic-m.otf.png') }}"><img src="{{ asset('images/freefont_logo_jk-maru-gothic-m.otf2.png') }}"></a></header>
